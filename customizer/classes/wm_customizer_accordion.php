...
class WM_Customizer_Accordion extends WP_Customize_Control {
    ...
    *
    * @since 1.0.0
    * @return HTML The correct HTML needed to mark the start and end of an accordion section.
    */
	public function render_content() {
		if( !empty( $this->label) ){
            ?>
				<span class="customize-control-title wm-customizer-accordion-toggle" onclick="toggleAccordion(this);"><?php echo $this->label; ?></span>
            <?php
        } else {
            ?>
